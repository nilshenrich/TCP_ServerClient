...
openssl ecparam -genkey -name prime256v1 -out keys/listener/listener.key
...
openssl ecparam -genkey -name prime256v1 -out selfSignedKeys/listener/listener.key
...
openssl ecparam -genkey -name prime256v1 -out secondKeys/listener/listener.key
...
openssl ecparam -genkey -name prime256v1 -out certChainDepth2Keys/listener/listener.key
