...
openssl req -new -x509 -days 36500 -key keys/ca/ca.key -out keys/ca/ca.crt -subj "/C=DE/ST=<my state>/L=<my city>/O=NetworkTester/OU=CA/CN=localhost"
...
openssl req -new -x509 -days 36500 -key selfSignedKeys/ca/ca.key -out selfSignedKeys/ca/ca.crt -subj "/C=DE/ST=<my state>/L=<my city>/O=NetworkTester/OU=CA/CN=localhost"

# Create listener key and certificate signed by self
openssl genrsa -out selfSignedKeys/listener/listener.key 2048
openssl req -new -x509 -days 36500 -key selfSignedKeys/listener/listener.key -out selfSignedKeys/listener/listener.crt -subj "/C=DE/ST=<my state>/L=<my city>/O=NetworkTester/OU=Listener/CN=localhost"

# Create client key and certificate signed by self
openssl genrsa -out selfSignedKeys/client/client.key 2048
openssl req -new -x509 -days 36500 -key selfSignedKeys/client/client.key -out selfSignedKeys/client/client.crt -subj "/C=DE/ST=<my state>/L=<my city>/O=NetworkTester/OU=Client/CN=localhost"
...
openssl req -new -x509 -days 36500 -key secondKeys/ca/ca.key -out secondKeys/ca/ca.crt -subj "/C=DE/ST=<my state>/L=<my city>/O=NetworkTester/OU=CA/CN=localhost"
