...
Forwarding_TcpConnection_Test_MsgTransfer::Forwarding_TcpConnection_Test_MsgTransfer() {}
Forwarding_TcpConnection_Test_MsgTransfer::~Forwarding_TcpConnection_Test_MsgTransfer() {}
...
// ====================================================================================================================
TEST_F(Forwarding_TcpConnection_Test_MsgTransfer, PosTest_ClientToServer_NormalMsg)
{
...
// ====================================================================================================================
TEST_F(Forwarding_TcpConnection_Test_MsgTransfer, PosTest_ServerToClient_NormalMsg)
{
...
// Exp Result: Message received by server
// ====================================================================================================================
TEST_F(Forwarding_TcpConnection_Test_MsgTransfer, PosTest_ClientToServer_LongMsg)
{
...
// Exp Result: Message received by client
// ====================================================================================================================
TEST_F(Forwarding_TcpConnection_Test_MsgTransfer, PosTest_ServerToClient_LongMsg)
{
    // Generate message with 1000000 elements of ASCII characters 33 - 126
    string msg;
    for (size_t i = 0; i < 1000000; i += 1)
