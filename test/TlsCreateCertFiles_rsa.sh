...
openssl req -new -x509 -days 365 -key keys/ca/ca.key -out keys/ca/ca.crt -subj "/C=DE/ST=<my state>/L=<my city>/O=test/OU=CA/CN=localhost"

# Create server key and certificate signed by CA
openssl genrsa -out keys/server/server.key 2048
openssl req -new -key keys/server/server.key -out keys/server/server.csr -subj "/C=DE/ST=<my state>/L=<my city>/O=test/OU=server/CN=localhost"
...
openssl req -new -key keys/client/client.key -out keys/client/client.csr -subj "/C=DE/ST=<my state>/L=<my city>/O=test/OU=Client/CN=localhost"
...
openssl req -new -x509 -days 365 -key selfSignedKeys/ca/ca.key -out selfSignedKeys/ca/ca.crt -subj "/C=DE/ST=<my state>/L=<my city>/O=test/OU=CA/CN=localhost"

# Create server key and certificate signed by self
openssl genrsa -out selfSignedKeys/server/server.key 2048
openssl req -new -x509 -days 365 -key selfSignedKeys/server/server.key -out selfSignedKeys/server/server.crt -subj "/C=DE/ST=<my state>/L=<my city>/O=test/OU=server/CN=localhost"

# Create client key and certificate signed by self
openssl genrsa -out selfSignedKeys/client/client.key 2048
openssl req -new -x509 -days 365 -key selfSignedKeys/client/client.key -out selfSignedKeys/client/client.crt -subj "/C=DE/ST=<my state>/L=<my city>/O=test/OU=Client/CN=localhost"
...
openssl req -new -x509 -days 365 -key secondKeys/ca/ca.key -out secondKeys/ca/ca.crt -subj "/C=DE/ST=<my state>/L=<my city>/O=test/OU=CA/CN=localhost"

# Create server key and certificate signed by second CA
openssl genrsa -out secondKeys/server/server.key 2048
openssl req -new -key secondKeys/server/server.key -out secondKeys/server/server.csr -subj "/C=DE/ST=<my state>/L=<my city>/O=test/OU=server/CN=localhost"
...
openssl req -new -key secondKeys/client/client.key -out secondKeys/client/client.csr -subj "/C=DE/ST=<my state>/L=<my city>/O=test/OU=Client/CN=localhost"
...
openssl genrsa -out certChainDepth2Keys/server/server.key 2048
openssl req -new -key certChainDepth2Keys/server/server.key -out certChainDepth2Keys/server/server.csr -subj "/C=DE/ST=<my state>/L=<my city>/O=test/OU=server/CN=localhost"
...
openssl req -new -key certChainDepth2Keys/client/client.key -out certChainDepth2Keys/client/client.csr -subj "/C=DE/ST=<my state>/L=<my city>/O=test/OU=Client/CN=localhost"
